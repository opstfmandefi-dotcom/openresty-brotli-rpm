...
Every Monday at 03:17 UTC, the **Release** workflow discovers all OpenResty
versions currently present in the official Rocky Linux 9 repository. It builds
the complete version/architecture matrix and creates one release per OpenResty
version. Existing releases are refreshed in place, making weekly rebuilds
idempotent.
...
for automatic discovery, or supply a comma-separated subset such as
`1.29.2.5,1.31.1.1`.
